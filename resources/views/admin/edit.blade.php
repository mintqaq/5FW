...
<form class="am-form tpl-form-line-form"  action="/admin/user/{{$res->uid}}" method="post" enctype='multipart/form-data'>
    @if (count($errors) > 0)
    ...
    <div class="am-form-group">
        <label for="user-name" class="am-u-sm-3 am-form-label">用户修改 <span class="tpl-form-line-small-title">UserName</span></label>
        <div class="am-u-sm-9">
            <input type="text" class="tpl-form-input" id="user-name" placeholder="请输入用户名" name="username" value="{{$res->username}}">
            <small>请填写用户名。</small>
        </div>
    </div>
    ...
    <!-- <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input type="password" placeholder="输入Password" name="password" value="{{$res->password}}">
            <small>请填写密码。</small>
        </div>
    </div> -->
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input type="text" placeholder="输入Realname" name="name" value="{{$res->name}}" disabled="">
            <small>请填写真实姓名。</small>
        </div>
    </div>
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <select name=sex data-am-selected="{searchBox: 1}" style="display: none;">
              <option value="1" @if($res->sex == 1) checked @endif>男</option>
              <option value="0" @if($res->sex == 1) checked @endif>女</option>
            </select>
        </div>
    </div>
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input type="text" placeholder="输入Email" name="email" value="{{$res->email}}" disabled="">
            <small>请填写邮箱。</small>
        </div>
    </div>
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input type="text" placeholder="Tel" name="phone" value="{{$res->phone}}" disabled="">
            <small>请填写电话号码。</small>
        </div>
    </div>
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input type="text" placeholder="输入Code" name="code" value="{{$res->code}}">
            <small>请填写邮编。</small>
        </div>
    </div>
        ...
        <div class="am-u-sm-9">
            <div class="am-form-group am-form-file">
                <div class="tpl-form-file-img">
                    <img src="{{$res->profile}}" alt="" style="width: 150px;height: 150px">
                </div>
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input type="text" placeholder="输入Address" name="address" value="{{$res->address}}">
            <small>请填写地址。</small>
        </div>
    </div>
